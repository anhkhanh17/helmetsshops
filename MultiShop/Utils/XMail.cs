...
namespace MultiShop.Utils
{
    public class XMail
    {
        ...
        public static string CredentialPassword = StringCipher.Decrypt(WebConfigurationManager.AppSettings["CredentialPassword"].ToString(), "c1bc0bgq");
        public static string EnableSsl = WebConfigurationManager.AppSettings["EnableSsl"].ToString();
        public static bool ssl = true;
        public static string from = WebConfigurationManager.AppSettings["from"].ToString();
        ...
        public static void Send(String from, String to, String subject, String body)
        {
            ...
            //   // SendAsyncEmail(from, to, cc, bcc, subject, body, attachments);
            //    Sends(from, to, cc, bcc, subject, body, attachments);
            //}).Start();
